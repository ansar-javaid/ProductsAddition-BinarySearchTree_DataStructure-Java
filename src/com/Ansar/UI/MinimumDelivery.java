...
public class MinimumDelivery extends javax.swing.JPanel{
    private LoadData loadData=new LoadData();
    DefaultTableModel model;
    /**
     * Creates new form MinimumDelivery
     */
    ...
    private void initComponents() {
        ...
        jLabel14.setText("View Minimum Delivery Charges");

        showAll.setBackground(new java.awt.Color(242, 247, 247));
        showAll.setText("Showl Product");
    ...
    private void showAllActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        {
            if(benchMark>productLinkedList.get(count).getDelivery_Charges())
            {
                benchMark=productLinkedList.get(count).getDelivery_Charges();
                System.out.println(productLinkedList.get(count).getID()+"<-"+count);
                index=count;
            }
        }
        model.addRow(new Object[]{productLinkedList.get(index).getID(),productLinkedList.get(index).getTitle(),
                productLinkedList.get(index).getPrice(),productLinkedList.get(index).getDelivery_Charges()});
    }
