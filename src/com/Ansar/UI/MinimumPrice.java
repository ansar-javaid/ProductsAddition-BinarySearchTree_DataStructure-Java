...
public class MinimumPrice extends javax.swing.JPanel{
    private LoadData loadData=new LoadData();
    DefaultTableModel model;
    /**
     * Creates new form MinimumPrice
     */
    public MinimumPrice() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setText("  View Minimum Price Product ");

        showAll.setBackground(new java.awt.Color(242, 247, 247));
        showAll.setText("Show Product");
    ...
    private void showAllActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        {
            if(benchMark>productLinkedList.get(count).getPrice())
            {
                benchMark=productLinkedList.get(count).getPrice();
